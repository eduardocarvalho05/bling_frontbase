...
export const ContainerContasPagar = styled.div`
  display: flex;
...
export const FormContainerContasPagar1 = styled.div`
  display: grid;
...
export const FormContainerContasPagar2 = styled.div`
  display: grid;
  grid-template-columns: 1fr;  
  gap: 16px;
  width: 30%;
...
export const FormContainerContasPagar3 = styled.div`
  display: grid;
...
export const FormContainerContasPagar4 = styled.div`
  display: flex;
  align-items: center;
